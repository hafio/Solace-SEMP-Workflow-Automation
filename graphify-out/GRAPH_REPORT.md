# Graph Report - SEMP-Workflow_Automation  (2026-08-10)

## Corpus Check
- 60 files · ~51,292 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 728 nodes · 1747 edges · 40 communities (36 shown, 4 thin omitted)
...
### Community 5 - "Template: `app-inbound`"
Cohesion: 0.18
...
### Community 6 - "Template: `app-outbound`"
Cohesion: 0.18
...
Cohesion: 0.17
Nodes (12): 1. 簡介, 2. 系統需求, 3. 開始使用, 4. 專案結構, 8. 內建範本說明, 9. 可用模組, app-inbound — APP 入站工作流程, app-outbound — APP 出站工作流程 (+4 more)
...
Cohesion: 0.29
Nodes (7): 10. 常見情境範例, 情境一：建立單一 APP 出站佇列組合, 情境三：批次建立多個工作流程, 情境二：建立 APP 入站流程（佇列 + RDP + REST 遞送）, 情境五：刪除資源, 情境六：循序遞送 vs 並發遞送, 情境四：使用全域變數統一管理設定
...
### Community 22 - "helpers_test.go"
Cohesion: 0.43
Nodes (7): T, TestCheckNameLength(), TestCleanPayload(), TestCoerceBool(), TestCoerceInt(), TestEnc(), TestStringify()
...
Cohesion: 0.06
Nodes (55): Duration, SEMPError, HandlerFunc, asSEMPError(), backoffDelay(), Request, Response, NewClient() (+47 more)
...
Cohesion: 0.11
Nodes (43): ActionSpec, AppConfig, SempConfig, WorkflowEntry, WorkflowTemplate, cfgBool(), cfgInt(), cfgStr() (+35 more)
...
- **Why does `Enc()` connect `Enc` to `runCLI`, `integrationClient`, `helpers_test.go`, `newTestClient`, `LoadConfig`?**
  _High betweenness centrality (0.132) - this node is a cross-community bridge._
- **Why does `exec()` connect `exec` to `capture`, `integrationClient`, `Enc`?**
  _High betweenness centrality (0.106) - this node is a cross-community bridge._
- **Why does `ActionResult` connect `Enc` to `capture`, `exec`?**
