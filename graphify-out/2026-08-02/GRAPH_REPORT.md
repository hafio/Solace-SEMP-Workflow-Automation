...
## Corpus Check
- 60 files · ~49,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 723 nodes · 1771 edges · 41 communities (37 shown, 4 thin omitted)
...
Cohesion: 0.32
Nodes (23): CGO_ENABLED, load_local_env(), main(), NO_COLOR, run_logged(), dev.sh script, die(), ok() (+15 more)

### Community 2 - "CLI Command Tests"
Cohesion: 0.35
Nodes (19): Have(), Import-LocalEnv(), Invoke-Logged(), Die(), Ok(), Step(), Task-All(), Task-Build() (+11 more)

### Community 3 - "Jinja2 Templating Engine"
Cohesion: 0.21
Nodes (13): cfgInt(), cfgStr(), CoerceBool(), CoerceInt(), isUnreserved(), Stringify(), T, TestCheckNameLength() (+5 more)
...
Cohesion: 0.05
Nodes (42): 10. 常見情境範例, 11. 故障排除, 1. 簡介, 2. 系統需求, 3. 開始使用, 4. 專案結構, 5.1 SEMP 連線設定, 5.2 全域變數（global_vars） (+34 more)

### Community 16 - "SEMP Workflow Automation — How-To Guide"
Cohesion: 0.17
Nodes (12): 1. Introduction, 2. Prerequisites, 3. Getting Started, 4. Project Structure, 8. Built-in Template Reference, 9. Available Modules, Build from source (Go 1.26+), Install a prebuilt binary (recommended) (+4 more)
...
### Community 24 - "6. Workflow Templates"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (41): ActionSpec, AppConfig, SempConfig, WorkflowEntry, WorkflowTemplate, Engine, Engine, engineFake (+33 more)
...
Cohesion: 0.19
Nodes (26): LoadConfig(), LoadTemplatesFS(), T, TestLoadConfigMissingFile(), TestLoadConfigMissingSemp(), TestLoadConfigMissingSempKey(), TestLoadConfigNotAMapping(), TestLoadConfigOverrides() (+18 more)
...
- **Why does `Enc()` connect `ACL Subscribe Exception Module` to `Engine & Config Core`, `Jinja2 Templating Engine`, `CLI Commands`, `Queue Binding Add Tests`, `newTestEngine`?**
  _High betweenness centrality (0.134) - this node is a cross-community bridge._
- **Why does `exec()` connect `Base Module Abstraction` to `CLI Commands`, `ACL Subscribe Exception Module`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `ActionResult` connect `ACL Subscribe Exception Module` to `RDP Consumer/Binding & Client`, `newTestEngine`, `Base Module Abstraction`?**
