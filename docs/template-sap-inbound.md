...
|---|---|---|
| `rc_name` | `"RC-SAP-REST"` | |
| `rc_remote_host` | `"sap-backend.internal"` | Override per environment |
| `rc_remote_port` | `80` | |
...
| Input | Default |
|---|---|
| `qb_post_request_target` | `"/sap/bc/rest/inbound"` |
...
| Publish topic exception | `CENTRAL/SAP/SITEB.ORDERS.ORDER-CREATE` |
| Service queue | `FROM-CENTRAL-SAP-SITEB.ORDERS.ORDER-CREATE` |
| Mirror queue | `MIRROR/FROM-CENTRAL-SAP-SITEB.ORDERS.ORDER-CREATE` |
| DMQ | `DMQ/FROM-CENTRAL-SAP-SITEB.ORDERS.ORDER-CREATE` |
| REST Delivery Point | `RDP/FROM-CENTRAL-SAP-SITEB.ORDERS.ORDER-CREATE` |
| REST Consumer | `RC-SAP-REST` -> `https://sap-backend.internal:443/sap/bc/rest/inbound` |
